...
"""
This script is used to produce a single Markdown file from the content of the subdirectories.
Run this when you make any changes to the subdirectories.

It will:
- Reset the README.md file (DO NOT EDIT THIS FILE)
- Add titles from the subdirectories names with appropriate size and add the content of their respective README.md files
